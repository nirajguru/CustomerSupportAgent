...
# Force UTF-8 on stdout/stderr so streamed agent output containing non-ASCII
# characters (emoji, curly quotes, etc.) doesn't crash on the Windows console,
# whose default cp1252 ('charmap') codec can't encode them.
